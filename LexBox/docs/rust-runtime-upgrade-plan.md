...
这份文档用于把当前 `LexBox`/`RedBox` 的 Rust 宿主，升级成一套更接近“可复用 AI 内核”的结构。
...
- 大量逻辑集中在单个 [main.rs](/Users/Jam/LocalDev/GitHub/RedConvert/LexBox/src-tauri/src/main.rs)
...
把当前 `LexBox` 里刚开始收敛的工具层，正式提升为可治理工具系统。
