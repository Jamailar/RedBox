...
use crate::{
    AdvisorRecord, WechatOfficialBindingRecord, configure_background_command, decode_base64_bytes,
    generate_chat_response, invoke_structured_chat_by_protocol, load_redbox_prompt_or_embedded,
    markdown_to_html, now_ms, payload_field, payload_string, render_redbox_prompt,
