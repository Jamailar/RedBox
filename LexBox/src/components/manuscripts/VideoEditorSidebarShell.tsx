...
export function VideoEditorSidebarShell({
    ...
    return (
        <aside className="col-start-1 row-start-1 min-h-0 border-r border-white/10 bg-[#17181c]">
            <div className="flex h-full min-h-0">
                <div className="flex w-[60px] shrink-0 flex-col items-center border-r border-white/10 bg-[#121317] px-2 py-3">
